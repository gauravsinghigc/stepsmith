...
function SENDMAILS($Subject, $Title, $Sendto, $MAIL_MSG, $die = false, $ReplyTo = null, array $Attachment = [null])
{
  ...
  $mail->Username   = 'no-reply@step-smith.com';                     //SMTP username
  $mail->Password   = 'Navix@9810';                               //SMTP password
  $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
  $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

  //Recipients
  $mail->setFrom('no-reply@step-smith.com', APP_INFO['APP_NAME']);
  ...
  //Attachments
  //Add attachments
  foreach($Attachment as $doc => $value){
  if($doc != null){
    if(file_exists($value)){
    $mail->addAttachment($value, $doc);
  }
  }
  }    
  //Content
  ...
  $mail->Body = '
    ...
    <img src="' . APP_INFO['APP_LOGO'] . '" style="width:30%;">
      <h3 style="color:black !important; font-weight:400 !important;margin-top:1rem;">' . $Title . '</h3>
      <p style="text-decoration:none !important; color: grey !important;font-size:13px;font-weight:300 !important;">' . $MAIL_MSG . '</p>
      <br><br><br>
     <p>
        <span>TEAM ' . APP_INFO['APP_NAME'] . '</span><br>
        <span style="text-decoration:none !important; color: grey !important;font-size:12px;font-weight:300 !important;">' . APP_ADDRESS['Address']['Details'] . '</span><br>
        <span style="text-decoration:none !important; color: grey !important;font-size:12px;font-weight:300 !important;">' . APP_PHONE_NUMBERS['whatsapp'] . '</span><br>
        </p>
      <br>
    </div>
   <p style="font-size:11px !important; color:grey !important; font-weight:300 !important;">
      <b>Note: </b> This is an auto generated mail. do not reply this. if you find something incorrect then forward this at ' . APP_EMAIL_ID['enquiry'] . '
   </p>
</body>';
